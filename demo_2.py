...
if __name__ == "__main__":
    ...
    S = [('keyfiles/0_public.pem', 5)] # public keys. Noted that each key should be binded with a pre-defined fix value "a", distributed together with the key. If not provided, a default value will be used.
